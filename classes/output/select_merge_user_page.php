...
/**
 * Contains the select_merge_user_page class.
 *
...
/**
 * Represents the page where the user to be merged gets selected.
 *
 * @copyright 2020, Carsten Schöffel <carsten.schoeffel@cs.hs-fulda.de>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @package tool_merge2users
 */
class select_merge_user_page extends select_user_page implements renderable {

    /**
     * select_merge_user_page constructor.
     *
    ...
    public function __construct($sort, $dir, $page, $perpage, $context, $selecteduserid) {
        $nextpage  = new \moodle_url('/admin/tool/merge2users/confirm_selection.php');
        $getparamname = 'mergeuserid';
        $heading = get_string('page_merge_user_heading', 'tool_merge2users');
