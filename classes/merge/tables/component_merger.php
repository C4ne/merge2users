...
/**
 * Contains the abstract component_merger class.
 *
...
/**
 * Class component_merger
 *
 * @copyright 2020, Carsten Schöffel <carsten.schoeffel@cs.hs-fulda.de>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @package tool_merge2users\merge\tables
 * TODO: Remove this class if only one class extends it.
 */
abstract class component_merger {
     ...
     * to be executed.
     */
    public abstract function get_sql_and_parameters_per_table();

    /**
     * component_merger constructor.
     *
