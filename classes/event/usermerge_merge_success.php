...
/**
 * Contains the usermerge_merge_success class.
 *
 ...
 * }
 */
class usermerge_merge_success extends usermerge_merge {
    ...
    public static function get_explanation() {
        return 'This event will be triggered everytime a merge of two users has succeeded';
    }
    ...
    public function get_description() {
        return 'Succeeded to merge user id'.$this->other['baseuserid'].'into user id '.$this->other['mergeuserid'];
    }
}